...
#if defined (_WIN32) || defined (_WIN32_WCE) || defined (_WIN64) || defined (__3DS__)
...
//#endif
#if defined (_WIN32) || defined (SDLIO) || defined (UNIXLIKE) || defined (macintosh) || defined (_WIN64) || defined (__3DS__)
